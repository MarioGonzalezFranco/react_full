export const Ic = ({ n, size=16, style={}, className='' }) => {
  const s = { display:'inline-flex', alignItems:'center', flexShrink:0, ...style };
  const p = { width:size, height:size, fill:'none', stroke:'currentColor', strokeWidth:2, strokeLinecap:'round', strokeLinejoin:'round' };
  ...
  const paths = {
    ...
    plus:       <svg {...p}><line x1="12" y1="5" x2="12" y2="19" strokeWidth="2.5"/><line x1="5" y1="12" x2="19" y2="12" strokeWidth="2.5"/></svg>,
    ...
    x:          <svg {...p}><line x1="18" y1="6" x2="6" y2="18" strokeWidth="2.5"/><line x1="6" y1="6" x2="18" y2="18" strokeWidth="2.5"/></svg>,
    check:      <svg {...p}><polyline points="20 6 9 17 4 12" strokeWidth="2.5"/></svg>,
    ...
    arrowUpDown:<svg {...p}><line x1="12" y1="20" x2="12" y2="4"/><polyline points="6 10 12 4 18 10"/><polyline points="6 14 12 20 18 14"/></svg>,
  ...
  return <span style={s} className={className}>{paths[n] || null}</span>;
};
